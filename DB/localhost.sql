...
--
-- Servidor: localhost
-- Tiempo de generación: 08-05-2013 a las 17:03:51
...
--
-- Base de datos: `TestPushNotification`
--
CREATE DATABASE `TestPushNotification` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `TestPushNotification`;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `apns_device_history`
--
...
--
-- Estructura de tabla para la tabla `apns_devices`
--
...
CREATE TABLE IF NOT EXISTS `apns_devices` (
  ...
  `appname` varchar(255) NOT NULL,
  `appversion` varchar(25) DEFAULT NULL,
  `devicetype` enum('Iphone','Android') NOT NULL,
  `deviceuid` char(52) NOT NULL,
  `devicetoken` char(200) NOT NULL,
  `devicename` varchar(255) NOT NULL,
  `devicemodel` varchar(100) NOT NULL,
  `deviceversion` varchar(25) NOT NULL,
  `pushbadge` enum('disabled','enabled') DEFAULT 'disabled',
  `pushalert` enum('disabled','enabled') DEFAULT 'disabled',
  `pushsound` enum('disabled','enabled') DEFAULT 'disabled',
  `development` enum('production','sandbox') CHARACTER SET latin1 NOT NULL DEFAULT 'sandbox',
  `status` enum('active','uninstalled') NOT NULL DEFAULT 'active',
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Store unique devices' AUTO_INCREMENT=51 ;


--
-- Estructura de tabla para la tabla `apns_messages`
--
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Messages to push to APNS' AUTO_INCREMENT=116 ;
